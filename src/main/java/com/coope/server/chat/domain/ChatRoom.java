...
public class ChatRoom extends BaseTimeEntity {
    ...
    public void updateLastMessage(Message message) {
        ...
        this.participants.forEach(p -> p.updateLastMessage(message.getCreatedAt(), summary));
    }

    public void updateTitleByParticipants(List<User> participants) {
        if (this.type != RoomType.GROUP || participants == null || participants.isEmpty()) return;
