...
public class Message extends BaseTimeEntity {
    ...
    @Builder
    public Message(ChatRoom chatRoom, User user, String content, String fileUrl,
                   String fileName, String fileFormat, MessageType type) {
    ...
    public static Message createTalkMessage(ChatRoom chatRoom, User sender,
                                            String content, String fileUrl, String fileName, String fileFormat) {
