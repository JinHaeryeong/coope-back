...
import com.coope.server.chat.domain.MessageType;
...
public class MessageResponse {
    ...
    @Builder
    private MessageResponse(Long id, Long roomId, Long senderId, String senderNickname,
                             String senderProfile, String content, MessageType type,
                             String fileUrl, String fileName, String fileFormat, LocalDateTime createdAt) {
        this.id = id;
        this.roomId = roomId;
