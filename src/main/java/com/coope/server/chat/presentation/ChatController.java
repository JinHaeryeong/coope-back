...
public class ChatController {
    ...
    public ResponseEntity<ChatRoomResponse> createGroupRoom(
        ...
        return ResponseEntity.ok(chatService.createGroupRoom(
                userDetails.getUser().getId(), request.getUserIds(), request.getRoomName()));
    }
    ...
    public ResponseEntity<Slice<MessageResponse>> getChatMessages(
        ...
        return ResponseEntity.ok(chatService.getChatMessages(
                roomId, userDetails.getUser().getId(), lastMessageId, pageable));
    }
