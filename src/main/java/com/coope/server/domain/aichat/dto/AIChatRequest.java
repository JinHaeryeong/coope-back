...
public class AIChatRequest {
    ...
    public static AIChatRequest createDefault(List<Message> allMessages) {
    ...
    public static  Message createSystemMessage() {
        String systemInstruction =
                "당신은 GPT-3.5-turbo 모델을 기반으로 한 웹 애플리케이션의 AI 어시스턴트입니다. "
        ...
        return new Message("system", systemInstruction);
    }
